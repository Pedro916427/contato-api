...
import br.com.lampiao.contatosapi.Contato;
import br.com.lampiao.contatosapi.ContatoRepositorio;
...
public class ContatoController {
	...
	public ResponseEntity<?> adicionaContato(@RequestBody Contato contato) {
		...
		URI uri = ServletUriComponentsBuilder.fromCurrentRequest().replacePath("/contato").path("/{id}")
	...
	@GetMapping
	public ResponseEntity<List<Contato>> listaClassContato() {
